...
public:
    ...
    static bool getClosestIntersection(const Ray &cameraRay, const vector<Shape*> &objectsList, Intersection &its);
    static bool hasIntersection(const Ray &ray, const vector<Shape*> &objectsList);
